...
namespace Zahzah\ModuleUser\Concerns\UserReference;
...
trait HasUserReference{
    ...
    //EIGER SECTION
    public function userReference(){return $this->morphOneModel('UserReference','reference');}
    public function userReferences(){return $this->morphManyModel('UserReference','reference');}

    public function user(){
        return $this->hasOneThroughModel(
            'User','UserReference',
            'reference_id',$this->getKeyName(),
            $this->getKeyName(),
            $this->getForeignKey()
