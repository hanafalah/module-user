...
namespace Hanafalah\ModuleUser\Facades;
 ...
 */
class ModuleUser extends \Illuminate\Support\Facades\Facade
{
  /**
  ...
  {
    return \Hanafalah\ModuleUser\Contracts\ModuleUser::class;
  }
}
